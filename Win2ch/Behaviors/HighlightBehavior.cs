...
namespace Win2ch.Behaviors {
    internal class HighlightBehavior : Behavior<Border> {
        ...
        protected override void OnAttached() {
            _oldBackground = AssociatedObject.Background;
            HighlightItem();
        }
        ...
        private void HighlightItem() {
            if (AssociatedObject == null)
                return;
            AssociatedObject.Background = _oldBackground ?? new SolidColorBrush(Colors.Transparent);
        ...
        protected override void OnDetaching() {
            AssociatedObject.Background = _oldBackground;
        }
    }
}
